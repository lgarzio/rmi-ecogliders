...
is for synthesizing the bottom and surface data from glider deployments and grouping them according to region
(inshore, midshelf, offshore) based on NOAA strata.
